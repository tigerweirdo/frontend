...
function BorcListesi() {
    ...
    const borclariYukle = () => {
        axios.get('https://oytuntekstil-06638c857215.herokuapp.com/api/borclar/api/borclar')
            .then(response => {
    ...
    const borcuSil = (id) => {
        confirm({
            ...
            onOk() {
                axios.delete(`https://oytuntekstil-06638c857215.herokuapp.com/api/borclar/api/borclar/${id}`)
                    .then(() => {
    ...
    const toggleOdemeDurumu = (id, odendiMi) => {
        axios.patch(`https://oytuntekstil-06638c857215.herokuapp.com/api/borclar/api/borclar/${id}`, { odendi_mi: !odendiMi })
            .then(() => {
